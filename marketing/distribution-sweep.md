...
Done as of v1.3.2. To re-publish after a future release:
...
> ancestor with upstream, GitHub then reports the branch as unmergeable, and the
> compare API returns `No common ancestor`. Clone in full, or `git fetch upstream` and
